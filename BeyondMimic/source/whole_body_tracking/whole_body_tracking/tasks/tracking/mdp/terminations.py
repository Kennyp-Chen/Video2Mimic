...
def bad_anchor_ori(
    ...
    # [isaaclab.utils.math] The function 'quat_rotate_inverse' will be deprecated in favor of the faster method 'quat_apply_inverse'. Please use 'quat_apply_inverse' instead....
