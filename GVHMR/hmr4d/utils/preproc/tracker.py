...
class Tracker:
    def __init__(self) -> None:
        # Fix PyTorch 2.7 safe loading issue - set weights_only=False
        import torch
        from ultralytics.nn.tasks import DetectionModel
        torch.serialization.add_safe_globals([torch.nn.Sequential, DetectionModel])
        
        # Patch torch.load to use weights_only=False for ultralytics
